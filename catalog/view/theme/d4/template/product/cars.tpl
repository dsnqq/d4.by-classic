...
<div class="container">
    <ul class="breadcrumb">
        ...
        <li style="font-size: 14px;line-height: 20px;color: #8D9293;text-decoration: none;">
            Авто в разборе
        </li>
    </ul>
                        ...
                        <div class="product-layout product-list col-lg-4 col-md-4 col-sm-6 col-xs-12" style="cursor:pointer;" onclick="location.href='<?php echo $product['href']; ?>';">
                            <div class="product_this">
                                ...
                                <div class="product_this__right">
                                    <div class="product_this__title" style="line-height: 20px;margin-top: 10px;">
                                        <?php echo $product['marka']; ?>
                                    ...
                                    <div class="product_this__flex">
                                        <div class="product_this__info">
                                            <div class="product_this_info__item">
                                                <span>Год:</span> <span><?php echo $product['year']; ?></span>
                                            </div>
                                        <div class="product_this_info__item"><span>Страна эксплуатации:</span> <span><?php echo $product['country']; ?></span></div>
                                        <div class="product_this_info__item"><span>Двигатель:</span> <span><?php echo $product['volume']; ?> <?php echo $product['typePower']; ?></span></div>
                                        <div class="product_this_info__item"><span>Кузов:</span> <span><?php echo $product['body']; ?></span></div>
                                        <div class="product_this_info__item"><span>Цвет:</span> <span><?php echo $product['color']; ?></span></div>
                                ...
                                <div class="product_this__grid">
                                    ...
                                    <a href="<?php echo $product['href']; ?>" class="product_this__btn">Посмотреть</a>
                                </div>
                            </div>
                        </div>
                    </div>
