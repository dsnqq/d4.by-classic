...
<div id="content">
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="/cars">Авто в разборе</a></li>
            ...
            <div class="left_product_page">
                ...
                <div class="product_info_page_g">
                    ...
                    <div class="product_info_y">
                        ...
                        <ul>
                            <li><span>Страна эксплуатации: </span><span><?php echo $country ?></span></li>
                            <li><span>Двигатель: </span><span><?php echo $volume . ' ' . $typePower; ?></span></li>

                            <?php if($body){ ?>
                            <li><span>Кузов: </span><span><?php echo $body; ?></span></li>
                            <?php } ?>
                            <?php if($color){ ?>
                            <li><span>Цвет: </span><span><?php echo $isbn; ?> <?php if($color){ echo $color; } ?></span></li>
                            <?php } ?>
