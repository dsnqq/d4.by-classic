...
// Text
$_['text_success']             = 'З/ч <a href="%s">%s</a> добавлена в вашу <a href="%s">корзину</a>!';
...
$_['column_model']           = 'Артикул (ext_id)';
$_['column_quantity']        = 'Кол-во';
$_['column_price']           = 'Цена за шт.';
$_['column_total']           = 'Всего';

// Error
$_['error_stock']              = 'Запчасти отмеченные *** отсутствуют в нужном количестве или их нет в наличии!';
$_['error_minimum']            = 'Минимальное количество товара для заказа %s равняется %s!';
$_['error_required']           = '%s необходим!';
$_['error_product']            = 'В вашей корзине нет ничего!';
