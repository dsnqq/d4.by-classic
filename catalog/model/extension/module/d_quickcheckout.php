...
public function array_merge_r_d() {
	...
	*/
	...
	public function getConfigSetting($id, $config_key, $store_id, $config_file = false, $customer_group_id = 0){
		...
		$result['step']['payment_address']['fields'] = $result['step']['payment_address']['fields'] + $this->model_d_quickcheckout_custom_field->getCustomFieldsConfigData('account');
		$result['step']['payment_address']['fields'] = $result['step']['payment_address']['fields'] + $this->model_d_quickcheckout_custom_field->getCustomFieldsConfigData('address');
		$result['step']['shipping_address']['fields'] = $result['step']['shipping_address']['fields'] + $this->model_d_quickcheckout_custom_field->getCustomFieldsConfigData('address');
