...
class ModelExtensionShippingXshippingpro extends Model {
	...
	public function getQuote($address) {
		...
		foreach($methods as $single_method) {
			...
			$method_desc= ($xshippingpro['desc'][$language_id]) ? '<span style="color: #999999;font-size: 11px;display:block" class="x-shipping-desc">'.$xshippingpro['desc'][$language_id].'</span>' : '';
