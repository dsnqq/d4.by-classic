<?php
class ControllerProductShinyForm extends Controller {
    private $error = array();
    ...
    public function index() {
        ...
        $product_info = $this->model_catalog_shiny->getProduct($product_id);
        ...
        if ($product_info) {
            ...
            if($this->request->get['product_id']) {
                if (!isBot($bname)) {
                    if (empty($this->session->data['user_id']) && empty($this->session->data['token'])) {
                        ...
                        $this->model_catalog_shiny->updateStax($this->request->get['product_id'], $nameStroke);
                    }
                }
            }
            ...
            $data['shirina']	 = $product_info['jan'];
            $data['vysota']	 = $product_info['isbn'];
            $data['r_size']	 = $product_info['mpn'];
            $data['marka']	     = $product_info['ean'];
            ...
            $results = $this->model_catalog_shiny->getProductImages($this->request->get['product_id']);
            ...
            $this->response->setOutput($this->load->view('product/shiny_form', $data));
        } else {
            $url = '';
