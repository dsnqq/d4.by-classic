<?php
class ControllerProductShiny extends Controller {
	public function index() {
		$this->load->language('product/shiny');
		...
		$data['breadcrumbs'][] = array(
			...
			//$product_total = $this->model_catalog_shiny->getTotalProducts();

			$results = $this->model_catalog_shiny->getProducts();
