<?php
// Heading
$_['heading_title']       = 'Horizontal Mega Menu'; 
...
$_['text_success']        = 'Success: You have modified module Horizontal Mega Menu!';
...
$_['tab_items']              = 'Horizontalmenu items';
$_['tab_settings']           = 'Horizontalmenu Settings';
$_['tab_html']               = 'Custom Html area';
$_['text_general']           = 'General';
$_['text_more_dropdown']     = '"More" dropdown categories';
$_['text_more2_dropdown']    = 'Featured Categories';
$_['text_languagerelated']   = 'Language related';
$_['text_customization']     = 'Customization';
$_['text_settings_isresponsive']     = 'Make Horizontalmenu Responsive:';
...
$_['text_settings_mobilemenuname']   = 'Mobile Horizontalmenu Name:';
...
$_['text_settings_menuskin']         = 'Horizontalmenu Skin:';
...
$_['text_settings_supercache']       = 'Enable Horizontalmenu cache:<br /><span class="help inred">Note that if you enable caching for the menu items the changes you make for categories and products will not reflect in the menu unless you edit the supermenu and then save so that the cache gets deleted</span>';
$_['text_settings_fproduct']         = 'Horizontalmenu Featured products';
$_['text_editfor']         			 = 'Edit for store: ';
...
$_['type_catcatprods']    = 'Category with subcategories then latest products';
...
$_['delete_old_version']  = 'Delete Old Version';

// Error
$_['error_permission']    = 'Warning: You do not have permission to modify module Horizontal Mega Menu!';
$_['error_permission_instructions']  = 'You do not have permissions to modify this module. Please navigate in admin to system > Users > User groups, edit the group your account is in and at Modify Permissions make sure to check extension/module/supermenu.';
$_['error_old_version']   = 'An old version of supermenu has been detected. In module list you should see supermenu twice. In order to solve the issue click the following button to delete the old version of supermenu and keep just the new one.';