...
//heading
    ...
    $_['text_edit'] = 'Редактирование Custom Quick Checkout';
...
// Heading
    ...
    $_['text_intro_create_setting'] = '<h4>Custom Quick Checkout.</h4>Вы только что установили новую версию модуля Custom Quick Checkout. Для начала вам нужно будет создать и настроить оформление заказа. Нажмите "Создать модуль" и настройте внешний вид. Затем установите Статус в положение "Да" и нажмите "Сохранить".';
