...
class ControllerExtensionModulePHE extends Controller {
	...
	<tbody>
		<tr>
			<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: center; padding: 7px;background:#ffffff"><a href="#"><img src="{no_image}" alt="iPhone" title="iPhone" /></a></td>
			<td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;background:#ffffff"><a href="#">iPhone</a><br />
	...
	public function email() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && isset($this->request->post['selected'])) {
			foreach ($this->request->post['selected'] as $template_id) {
				...
				$replace = array('Иван', 'Иванов', 'test@example.com', '+7 999 1234567', 'mypassword', 'Тема письма', '1', '1', '01/01/2000', 'PayPal', 'СДЕК', '127.0.0.1', 'Оплатите на наш счет #123456', 'Адрес клиента', 'Адрес доставки', $product_table, $this->comment_table, '20', '120', '20', '120', '20', '120', '1', 'Подарочный сертификат.', 'abc123', '$10.00', 'Иван', 'Петров', '<img src="' . $this->model_tool_image->resize('no_image.png', 50, 50) . '" />');
	...
	public function install() {
		...
		$this->db->query("INSERT INTO `" . DB_PREFIX . "email_template_description` (`email_template_id`, `language_id`, `subject`, `message`) VALUES
			(1, 1, 'Регистрация в магазине " . $this->config->get('config_name') . "', '&lt;p&gt;Здравствуйте {firstname}. Спасибо за регистрацию в магазине " . $this->config->get('config_name') . "!&lt;/p&gt;\r\n\r\n&lt;p&gt;Ваша учетная запись была создана, и вы можете войти, используя свой адрес электронной почты и пароль, посетив наш веб-сайт по ссылке:&lt;/p&gt;\r\n\r\n&lt;p&gt;&amp;raquo; Логин:&amp;nbsp;&lt;a href=&quot;" . HTTP_CATALOG . "index.php?route=account/login&quot;&gt;" . HTTP_CATALOG . "index.php?route=account/login&lt;/a&gt;&lt;br /&gt;\r\n&lt;span style=&quot;font-size: 13px;&quot;&gt;&amp;raquo; Email: {email}&lt;/span&gt;&lt;br /&gt;\r\n&lt;span style=&quot;line-height: 1.6em;&quot;&gt;&amp;raquo; Пароль: {password}&lt;/span&gt;&lt;/p&gt;\r\n\r\n&lt;p&gt;После входа в систему вы сможете получить доступ к другим услугам, включая просмотр прошлых заказов, печать счетов и редактирование информации о вашей учетной записи.&lt;/p&gt;\r\n\r\n&lt;p&gt;С наилучшими пожеланиями,&lt;br /&gt;\r\n" . $this->config->get('config_name') . "&lt;/p&gt;\r\n\r\n'),
			(2, 1, 'Приветствуем в магазине " . $this->config->get('config_name') . "''s Affiliate Program', '&lt;p&gt;Здравствуйте {firstname} and thank you for joining " . $this->config->get('config_name') . "''s Affiliate Program.&lt;/p&gt;\r\n\r\n&lt;p&gt;Your account must be approved before you can login. Once approved you can log in by using your email address and password by visiting our website or at the following URL:&lt;/p&gt;\r\n\r\n&lt;p&gt;&lt;span style=&quot;font-size: 13px;&quot;&gt;&amp;raquo; Логин:&amp;nbsp;&lt;/span&gt;&lt;a href=&quot;" . HTTP_CATALOG . "index.php?route=affiliate/login&quot;&gt;" . HTTP_CATALOG . "index.php?route=affiliate/login&lt;/a&gt;&lt;br style=&quot;font-size: 13px;&quot; /&gt;\r\n&lt;span style=&quot;font-size: 13px;&quot;&gt;&amp;raquo; Email: {email}&lt;/span&gt;&lt;br style=&quot;font-size: 13px;&quot; /&gt;\r\n&lt;span style=&quot;font-size: 13px; line-height: 1.6em;&quot;&gt;&amp;raquo; Пароль: {password}&lt;/span&gt;&lt;/p&gt;\r\n\r\n&lt;p&gt;Upon logging in, you will be able to generate tracking codes, track commission payments and edit your account information.&lt;/p&gt;\r\n\r\n&lt;p&gt;С наилучшими пожеланиями,&lt;br /&gt;\r\n" . $this->config->get('config_name') . "&lt;/p&gt;\r\n\r\n'),
			(3, 1, 'Спасибо за обращение в " . $this->config->get('config_name') . "', '&lt;p&gt;Здравствуйте {firstname},&lt;/p&gt;\r\n\r\n&lt;p&gt;Благодарим Вас за обращение к нам. Мы свяжемся с вами как можно скорее.&lt;/p&gt;\r\n\r\n&lt;p&gt;Ниже то, что вы отправили нам:&lt;/p&gt;\r\n\r\n&lt;p&gt;&amp;nbsp;&lt;/p&gt;\r\n\r\n&lt;p&gt;&lt;strong&gt;{enquiry}&lt;/strong&gt;&lt;/p&gt;\r\n\r\n&lt;p&gt;&amp;nbsp;&lt;/p&gt;\r\n\r\n&lt;p&gt;Если вы ввели что-то неправильно, отправьте еще одно письмо.&lt;/p&gt;\r\n\r\n&lt;p&gt;С наилучшими пожеланиями,&lt;br /&gt;\r\n" . $this->config->get('config_name') . "&lt;/p&gt;\r\n\r\n'),
			...
			(5, 1, 'Ваш заказ в магазине " . $this->config->get('config_name') . "', '&lt;p&gt;Благодарим Вас за интерес к нашим товарам. Ваш заказ получен и будет обработан после подтверждения оплаты.&lt;/p&gt;\r\n\r\n&lt;table style=&quot;border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;&quot;&gt;\r\n	&lt;thead&gt;\r\n		&lt;tr&gt;\r\n			&lt;td colspan=&quot;2&quot; style=&quot;font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; background-color: #cccccc; font-weight: bold; text-align: left; padding: 7px; color: #222222;&quot;&gt;Детали заказа&lt;/td&gt;\r\n		&lt;/tr&gt;\r\n	&lt;/thead&gt;\r\n	&lt;tbody&gt;\r\n		&lt;tr&gt;\r\n			&lt;td style=&quot;font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;background:#ffffff&quot;&gt;&lt;b&gt;Номер заказа:&lt;/b&gt; {order_id}&lt;br /&gt;\r\n			&lt;b&gt;Дата создания:&lt;/b&gt; {date_added}&lt;br /&gt;\r\n			&lt;b&gt;Способ оплаты:&lt;/b&gt; {payment_method}&lt;br /&gt;\r\n			&lt;b&gt;Способ доставки:&lt;/b&gt; {shipping_method}&lt;/td&gt;\r\n			&lt;td style=&quot;font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;background:#ffffff&quot;&gt;&lt;b&gt;Email:&lt;/b&gt; {email}&lt;br /&gt;\r\n			&lt;b&gt;Телефон:&lt;/b&gt; {telephone}&lt;br /&gt;\r\n			&lt;b&gt;IP адрес:&lt;/b&gt; {ip}&lt;/td&gt;\r\n		&lt;/tr&gt;\r\n	&lt;/tbody&gt;\r\n&lt;/table&gt;\r\n\r\n&lt;p&gt;{comment_table}&lt;/p&gt;\r\n\r\n&lt;table style=&quot;border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;&quot;&gt;\r\n	&lt;thead&gt;\r\n		&lt;tr&gt;\r\n			&lt;td style=&quot;font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; background-color: #cccccc; font-weight: bold; text-align: left; padding: 7px; color: #222222;&quot;&gt;Адрес клиента:&lt;/td&gt;\r\n			&lt;td style=&quot;font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; background-color: #cccccc; font-weight: bold; text-align: left; padding: 7px; color: #222222;&quot;&gt;Адрес доставки:&lt;/td&gt;\r\n		&lt;/tr&gt;\r\n	&lt;/thead&gt;\r\n	&lt;tbody&gt;\r\n		&lt;tr&gt;\r\n			&lt;td style=&quot;font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;background:#ffffff;&quot;&gt;{payment_address}&lt;/td&gt;\r\n			&lt;td style=&quot;font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;background:#ffffff&quot;&gt;{shipping_address}&lt;/td&gt;\r\n		&lt;/tr&gt;\r\n	&lt;/tbody&gt;\r\n&lt;/table&gt;\r\n\r\n&lt;p&gt;{product_table}&lt;/p&gt;\r\n\r\n&lt;p&gt;С наилучшими пожеланиями,&lt;br /&gt;\r\n" . $this->config->get('config_name') . "&lt;/p&gt;\r\n\r\n'),
			(7, 1, 'Ваш заказ #{order_id} изменен', '&lt;p&gt;Здравствуйте {firstname},&lt;/p&gt;\r\n\r\n&lt;p&gt;В настоящее время мы обрабатываем ваш заказ. Напишите нам по электронной почте, если у вас есть какие-либо вопросы.&lt;/p&gt;\r\n\r\n&lt;p&gt;{comment}&lt;/p&gt;\r\n\r\n&lt;p&gt;С наилучшими пожеланиями,&lt;br /&gt;\r\n" . $this->config->get('config_name') . "&lt;/p&gt;\r\n'),
			(8, 1, 'Reward Points', '&lt;p&gt;Здравствуйте {firstname},&lt;/p&gt;\r\n\r\n&lt;p&gt;You have received {points} reward points! You may now spend it in our store.&lt;/p&gt;\r\n\r\n&lt;p&gt;You currently have a total of {total_points} reward points.&lt;/p&gt;\r\n\r\n&lt;p&gt;С наилучшими пожеланиями,&lt;br /&gt;\r\n" . $this->config->get('config_name') . "&lt;/p&gt;\r\n\r\n'),
			(9, 1, 'Аккаунт подтвержден', '&lt;p&gt;Здравствуйте {firstname},&lt;/p&gt;\r\n\r\n&lt;p&gt;&lt;span style=&quot;font-size: 13px;&quot;&gt;Ваша учетная запись была одобрена, и вы можете войти, используя свой адрес электронной почты и пароль, посетив наш веб-сайт или по следующему URL-адресу:&lt;/span&gt;&lt;/p&gt;\r\n\r\n&lt;p&gt;&lt;span style=&quot;font-size: 13px;&quot;&gt;&amp;raquo; Логин:&amp;nbsp;&lt;/span&gt;&lt;a href=&quot;" . HTTP_CATALOG . "index.php?route=account/login&quot; style=&quot;font-size: 13px;&quot;&gt;" . HTTP_CATALOG . "index.php?route=account/login&lt;/a&gt;&lt;br style=&quot;font-size: 13px;&quot; /&gt;\r\n&lt;span style=&quot;font-size: 13px;&quot;&gt;&amp;raquo; Email: {email}&lt;/span&gt;&lt;br style=&quot;font-size: 13px;&quot; /&gt;\r\n&amp;nbsp;&lt;/p&gt;\r\n\r\n&lt;p style=&quot;font-size: 13px;&quot;&gt;Ваша учетная заПосле входа в систему вы сможете получить доступ к другим услугам, включая просмотр прошлых заказов, печать счетов и редактирование информации о вашей учетной записи.&lt;/p&gt;\r\n\r\n'),
			(10, 1, 'Store Credits', '&lt;p style=&quot;font-size: 13px;&quot;&gt;Здравствуйте {firstname},&lt;/p&gt;\r\n\r\n&lt;p style=&quot;font-size: 13px;&quot;&gt;You have received {credits} store credits! You may now spend it in our store.&lt;/p&gt;\r\n\r\n&lt;p style=&quot;font-size: 13px;&quot;&gt;You currently have a total of {total_credits} store credits.&lt;/p&gt;\r\n\r\n'),
			(11, 1, 'Affiliate Approved', '&lt;p style=&quot;font-size: 13px;&quot;&gt;Здравствуйте {firstname} and thank you for joining " . $this->config->get('config_name') . "''s Affiliate Program.&lt;/p&gt;\r\n\r\n&lt;p style=&quot;font-size: 13px;&quot;&gt;Your account has been approved.&amp;nbsp;You can now log in by using your email address and password by visiting our website or at the following URL:&lt;/p&gt;\r\n\r\n&lt;p style=&quot;font-size: 13px;&quot;&gt;&amp;raquo; Логин:&amp;nbsp;&lt;a href=&quot;" . HTTP_CATALOG . "index.php?route=affiliate/login&quot;&gt;" . HTTP_CATALOG . "index.php?route=affiliate/login&lt;/a&gt;&lt;br /&gt;\r\n&amp;raquo; Email: {email}&lt;/p&gt;\r\n\r\n&lt;p style=&quot;font-size: 13px;&quot;&gt;Upon logging in, you will be able to generate tracking codes, track commission payments and edit your account information.&lt;/p&gt;\r\n\r\n'),
			(12, 1, 'Commission Earned', '&lt;p style=&quot;font-size: 13px;&quot;&gt;Здравствуйте {firstname},&lt;/p&gt;\r\n\r\n&lt;p style=&quot;font-size: 13px;&quot;&gt;You have received {commission} commission!&lt;/p&gt;\r\n\r\n&lt;p style=&quot;font-size: 13px;&quot;&gt;You have currently earned&amp;nbsp;a total of {total_commission} commission.&lt;/p&gt;\r\n\r\n'),
			(13, 1, 'Product Return Request Complete', '&lt;p&gt;Здравствуйте {firstname},&lt;/p&gt;&lt;p&gt;Your return request (Return ID {return_id}) has been completed.&lt;/p&gt;&lt;p&gt;{comment}&lt;/p&gt;&lt;p&gt;С наилучшими пожеланиями,&lt;br /&gt;" . $this->config->get('config_name') . "&lt;/p&gt;'),
			(14, 1, 'You have been sent a gift voucher from {from_name}', '&lt;p&gt;Hi {to_name},&lt;/p&gt;&lt;p&gt;{voucher_theme}&lt;/p&gt;&lt;p&gt;You have received a gift voucher worth {amount}.&lt;/p&gt;&lt;p&gt;Message from {from_name}:&lt;/p&gt;&lt;p&gt;{message}&lt;/p&gt;&lt;p&gt;You can redeem the gift voucher with the&amp;nbsp;code &lt;strong&gt;{code}&lt;/strong&gt; on our website.&lt;/p&gt;&lt;p&gt;С наилучшими пожеланиями,&lt;br /&gt;" . $this->config->get('config_name') . "&lt;/p&gt;');
		");
	}
