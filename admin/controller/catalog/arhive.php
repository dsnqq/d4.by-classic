<?php
class ControllerCatalogArhive extends Controller {
	private $error = array();
	...
	public function add() {
		...
		if(!$this->request->post['main_category_dop']){
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
				...
				$this->model_catalog_arhive->addProduct($this->request->post);
			...
			if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
				...
				$this->model_catalog_arhive->addProduct($this->request->post); // добавляем основную з/ч
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_catalog_arhive->editProduct($this->request->get['product_id'], $this->request->post);
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $product_id) {
				$this->model_catalog_arhive->deleteProduct($product_id);
			}
	...
	public function deleted() {
		...
		$this->load->model('catalog/product');
		$this->model_catalog_arhive->deleteProduct($this->request->get['product_id']);
	...
	public function copy() {
		...
		if (isset($this->request->post['selected']) && $this->validateCopy()) {
			foreach ($this->request->post['selected'] as $product_id) {
				$this->model_catalog_arhive->copyProduct($product_id);
			}
	...
	protected function getList() {
		...
		$product_total = $this->model_catalog_arhive->getTotalProducts($filter_data);
      ...
      $url .= '&filter_category=' . $this->request->get['filter_category'];
		...
		$pagination->url = $this->url->link('catalog/arhive', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
    ...
    if ($this->config->get('config_editor_default')) {
		...
		if (isset($this->request->post['product_description'])) {
			...
			$data['product_description'] = $this->model_catalog_arhive->getProductDescriptions($this->request->get['product_id']);
		} else {
    ...
    $data['manufacturers'] = $this->model_catalog_manufacturer->getManufacturers();
		...
		if (isset($this->request->post['main_category_id'])) {
			...
			$data['main_category_id'] = $this->model_catalog_arhive->getProductMainCategoryId($this->request->get['product_id']);
		} else {
		...
		if (isset($this->request->post['product_category'])) {
			...
			$data['product_category'] = $this->model_catalog_arhive->getProductCategories($this->request->get['product_id']);
		} else {
		...
		if (isset($this->request->post['product_filter'])) {
			...
			$filters = $this->model_catalog_arhive->getProductFilters($this->request->get['product_id']);
		} else {
			$filters = array();
		}
		...
		if (isset($this->request->post['product_attribute'])) {
			...
			$product_attributes = $this->model_catalog_arhive->getProductAttributes($this->request->get['product_id']);
		} else {
		...
		if (isset($this->request->post['product_option'])) {
			...
			$product_options = $this->model_catalog_arhive->getProductOptions($this->request->get['product_id']);
		} else {
		...
		*/
		...
		if (isset($this->request->post['product_special'])) {
			...
			$product_specials = $this->model_catalog_arhive->getProductSpecials($this->request->get['product_id']);
		} else {
		...
		if (isset($this->request->post['product_image'])) {
			...
			$product_images = $this->model_catalog_arhive->getProductImages($this->request->get['product_id']);
		} else {
		...
		if (isset($this->request->post['product_download'])) {
			...
			$product_downloads = $this->model_catalog_arhive->getProductDownloads($this->request->get['product_id']);
		} else {
		...
		if (isset($this->request->post['product_related'])) {
			...
			$products = $this->model_catalog_arhive->getProductRelated($this->request->get['product_id']);
		} else {
			$products = array();
		}
		...
		foreach ($products as $product_id) {
			$related_info = $this->model_catalog_arhive->getProduct($product_id);
	...
	protected function validateForm() {
		...
		if($this->request->post['model'] == ""){
			$chekMaxModel = $this->model_catalog_arhive->chekMaxModel();
			$chekMaxModel['MAX(product_id)'] = $chekMaxModel['MAX(product_id)'] + 2;
			$this->request->post['model'] = $chekMaxModel['MAX(product_id)'];
		} else{
			$model_product_info = $this->model_catalog_arhive->getModelProduct($this->request->post['model']);
	...
	public function autocomplete() {
		...
		if (isset($this->request->get['filter_name']) || isset($this->request->get['filter_model'])) {
			...
			foreach ($results as $result) {
				...
				$product_options = $this->model_catalog_arhive->getProductOptions($result['product_id']);
