...
class ControllerCatalogCategoryMgrLite extends Controller {
    ...
    public function index() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href'      => $this->url->link('catalog/category_mgr_lite', 'token=' . $this->session->data['token']. '', true),
        );
        ...
        $data['action'] = $this->url->link('extension/module/category_mgr_lite', 'token=' . $this->session->data['token'], true);
        ...
        $this->response->setOutput($this->load->view('catalog/category_mgr_lite', $data));
