<?php
class ControllerCatalogArhiveCar extends Controller {
    private $error = array();

    public function index() {
        $this->load->language('catalog/arhive_car');

        $this->document->setTitle($this->language->get('heading_title'));

        $this->load->model('catalog/arhive_car');
    ...
    public function add() {
        ...
        if(!$this->request->post['main_category_dop']){
            if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
                ...
                $this->model_catalog_arhive_car->addProduct($this->request->post);
            ...
            if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
                ...
                $this->model_catalog_arhive_car->addProduct($this->request->post); // добавляем основную з/ч
    ...
    public function edit() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            $this->model_catalog_arhive_car->editProduct($this->request->get['product_id'], $this->request->post);
    ...
    public function delete() {
        ...
        if (isset($this->request->post['selected']) && $this->validateDelete()) {
            foreach ($this->request->post['selected'] as $product_id) {
                $this->model_catalog_arhive_car->deleteProduct($product_id);
            }
    ...
    public function deleted() {
        ...
        $this->load->model('catalog/arhive_car');
        $this->model_catalog_arhive_car->deleteProduct($this->request->get['product_id']);
    ...
    public function copy() {
        ...
        if (isset($this->request->post['selected']) && $this->validateCopy()) {
            foreach ($this->request->post['selected'] as $product_id) {
                $this->model_catalog_arhive_car->copyProduct($product_id);
            }
    ...
    protected function getList() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('catalog/arhive_car', 'token=' . $this->session->data['token'] . $url, true)
        );

        $data['add'] = $this->url->link('catalog/arhive_car/add', 'token=' . $this->session->data['token'] . $url, true);
        $data['copy'] = $this->url->link('catalog/arhive_car/copy', 'token=' . $this->session->data['token'] . $url, true);
        $data['delete'] = $this->url->link('catalog/arhive_car/delete', 'token=' . $this->session->data['token'] . $url, true);
        ...
        $product_total = $this->model_catalog_arhive_car->getTotalProducts($filter_data);

        $product_total_count = $this->model_catalog_arhive_car->getProductCount();

        $data['product_total_count_all'] = $product_total_count;
        $data['product_total_count'] = $product_total;

        $results = $this->model_catalog_arhive_car->getProducts($filter_data);
        ...
        foreach ($results as &$result) {
            if($result['images']) {
                $result['images'] = explode(",", $this->model_tool_image->resize($result['images'], 150, 150));
            }
        }
        ...
        foreach ($results as $result) {
            $data['products'][] = array(
                ...
                'restore'    => $this->url->link('catalog/arhive_car/restore', 'token=' . $this->session->data['token'] . '&product_id=' . $result['product_id'] . $url, true),
        ...
        $data['sort_name'] = $this->url->link('catalog/product', 'token=' . $this->session->data['token'] . '&sort=name' . $url, true);
        $data['sort_model'] = $this->url->link('catalog/product', 'token=' . $this->session->data['token'] . '&sort=model' . $url, true);
        $data['sort_price'] = $this->url->link('catalog/product', 'token=' . $this->session->data['token'] . '&sort=price' . $url, true);
        $data['sort_quantity'] = $this->url->link('catalog/product', 'token=' . $this->session->data['token'] . '&sort=quantity' . $url, true);
        $data['sort_status'] = $this->url->link('catalog/product', 'token=' . $this->session->data['token'] . '&sort=status' . $url, true);
        $data['sort_order'] = $this->url->link('catalog/product', 'token=' . $this->session->data['token'] . '&sort=sort_order' . $url, true);
        ...
        $this->response->setOutput($this->load->view('car/arhive_car', $data));
    }
    ...
    public function restore() {
        ...
        $this->load->model('catalog/arhive_car');
        $this->model_catalog_arhive_car->restoreProduct($this->request->get['product_id']);
        ...
        //$this->response->redirect($this->url->link('car/arhive_car', 'token=' . $this->session->data['token'] . $url, true));
        $this->getList();
    }
    ...
    protected function getForm() {
        ...
        $this->load->model('catalog/arhive_car');
        $data['cancel'] = $this->url->link('catalog/arhive_car', 'token=' . $this->session->data['token'] . $url, true);

        if (isset($this->request->get['product_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
            $product_info = $this->model_catalog_arhive_car->getProduct($this->request->get['product_id']);
        }
        ...
        if (isset($this->request->post['product_description'])) {
            ...
            $data['product_description'] = $this->model_catalog_arhive_car->getProductDescriptions($this->request->get['product_id']);
        } else {
        ...
        if (isset($this->request->post['main_category_id'])) {
            ...
            $data['main_category_id'] = $this->model_catalog_arhive_car->getProductMainCategoryId($this->request->get['product_id']);
        } else {
        ...
        if (isset($this->request->post['product_category'])) {
            ...
            $data['product_category'] = $this->model_catalog_arhive_car->getProductCategories($this->request->get['product_id']);
        } else {
        ...
        if (isset($this->request->post['product_filter'])) {
            ...
            $filters = $this->model_catalog_arhive_car->getProductFilters($this->request->get['product_id']);
        } else {
            $filters = array();
        }
        ...
        if (isset($this->request->post['product_attribute'])) {
            ...
            $product_attributes = $this->model_catalog_arhive_car->getProductAttributes($this->request->get['product_id']);
        } else {
        ...
        if (isset($this->request->post['product_image'])) {
            ...
            $product_images = $this->model_catalog_arhive_car->getProductImages($this->request->get['product_id']);
        } else {
        ...
        $this->response->setOutput($this->load->view('catalog/arhive_car_form', $data));
    }
    ...
    protected function validateForm() {
        ...
        if($this->request->post['model'] == ""){
            $chekMaxModel = $this->model_catalog_arhive_car->chekMaxModel();
            $chekMaxModel['MAX(product_id)'] = $chekMaxModel['MAX(product_id)'] + 2;
            $this->request->post['model'] = $chekMaxModel['MAX(product_id)'];
        } else{
            $model_product_info = $this->model_catalog_arhive_car->getModelProduct($this->request->post['model']);
    ...
    public function autocomplete() {
        ...
        if (isset($this->request->get['filter_name']) || isset($this->request->get['filter_model'])) {
            ...
            foreach ($results as $result) {
                ...
                $product_options = $this->model_catalog_arhive_car->getProductOptions($result['product_id']);
