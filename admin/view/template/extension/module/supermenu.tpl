      		...
      		<div class="panel-heading">
        		<div class="input-group">
					...
					<select class="form-control" onchange="location = this.value;">
						<option <?php echo $store==0 ? 'selected="selected"' : '' ; ?> value="<?php echo $module_url; ?>">По умолчанию</option>
																...
																<td><select name="supermenu_item[<?php echo $item_row; ?>][chtml]">
																	...
																	<select name="supermenu_item[<?php echo $item_row; ?>][cchtml]">
																		<?php if ($item['cchtml'] == 'area1') { ?>
																			<option value="area1" selected="selected">Блок 1</option>
																		<?php } else { ?>
																			<option value="area1">Блок 1</option>
																		<?php } ?>
																		<?php if ($item['cchtml'] == 'area2') { ?>
																			<option value="area2" selected="selected">Блок 2</option>
																		<?php } else { ?>
																			<option value="area2">Блок 2</option>
																		<?php } ?>
																		<?php if ($item['cchtml'] == 'area3') { ?>
																			<option value="area3" selected="selected">Блок 3</option>
																		<?php } else { ?>
																			<option value="area3">Блок 3</option>
																		<?php } ?>
																		<?php if ($item['cchtml'] == 'area4') { ?>
																			<option value="area4" selected="selected">Блок 4</option>
																		<?php } else { ?>
																			<option value="area4">Блок 4</option>
																		<?php } ?>
																		<?php if ($item['cchtml'] == 'area5') { ?>
																			<option value="area5" selected="selected">Блок 5</option>
																		<?php } else { ?>
																			<option value="area5">Блок 5</option>
																		<?php } ?>
																		<?php if ($item['cchtml'] == 'area6') { ?>
																			<option value="area6" selected="selected">Блок 6</option>
																		<?php } else { ?>
																			<option value="area6">Блок 6</option>
																		<?php } ?>
																		<?php if ($item['cchtml'] == 'area7') { ?>
																			<option value="area7" selected="selected">Блок 7</option>
																		<?php } else { ?>
																			<option value="area7">Блок 7</option>
																		<?php } ?>
																		<?php if ($item['cchtml'] == 'area8') { ?>
																			<option value="area8" selected="selected">Блок 8</option>
																		<?php } else { ?>
																			<option value="area8">Блок 8</option>
																		<?php } ?>
																		<?php if ($item['cchtml'] == 'area9') { ?>
																			<option value="area9" selected="selected">Блок 9</option>
																		<?php } else { ?>
																			<option value="area9">Блок 9</option>
																		<?php } ?>
																		<?php if ($item['cchtml'] == 'area10') { ?>
																			<option value="area10" selected="selected">Блок 10</option>
																		<?php } else { ?>
																			<option value="area10">Блок 10</option>
																		<?php } ?>
																	</select>
															</td>
				...
				<div class="tab-pane" id="tab-settings">
					<div class="row">
						<div class="col-sm-5 col-xs-12" >
							...
							<div class="settings-row">
								...
								<select name="supermenu_skin">
				  					...
				  					<?php if ($supermenu_skin == 'white') { ?>
                  						<option value="white" selected="selected">Белый</option>
                  					<?php } else { ?>
                  						<option value="white">Белый</option>
                  					<?php } ?>
				  					<?php if ($supermenu_skin == 'alt1') { ?>
                  						<option value="alt1" selected="selected">Шаблон 1</option>
                  					<?php } else { ?>
                  						<option value="alt1">Шаблон 1</option>
                  					<?php } ?>
				  					<?php if ($supermenu_skin == 'alt2') { ?>
                  						<option value="alt2" selected="selected">Шаблон 2</option>
                  					<?php } else { ?>
                  						<option value="alt2">Шаблон 2</option>
                  					<?php } ?>
				  					<?php if ($supermenu_skin == 'imgmenu') { ?>
                  						<option value="imgmenu" selected="selected">Графичное меню</option>
                  					<?php } else { ?>
                  						<option value="imgmenu">Графичное меню</option>
                  					<?php } ?>
								</select>		  
							</div>
							<div class="settings-row">
								...
								<select name="supermenu_topitemlink">
			      					<?php if ($supermenu_topitemlink == 'bottom') { ?>
                  						<option value="bottom" selected="selected">Кнопка "Смотреть все" в низу выпадающего окна</option>
                  					<?php } else { ?>
                  						<option value="bottom">Кнопка "Смотреть все" в низу выпадающего окна</option>
                  					<?php } ?>
				  					<?php if ($supermenu_topitemlink == 'topitem') { ?>
                  						<option value="topitem" selected="selected">Главный пукт меню имеет ссылку</option>
                  					<?php } else { ?>
                  						<option value="topitem">Главный пукт меню имеет ссылку</option>
                  					<?php } ?>
				  					<?php if ($supermenu_topitemlink == 'heading') { ?>
                  						<option value="heading" selected="selected">Заголовок в выпадающем окне имеет ссылку</option>
                  					<?php } else { ?>
                  						<option value="heading">Заголовок в выпадающем окне имеет ссылку</option>
                  					<?php } ?>
								</select>		  
							</div>
							<div class="settings-row">
								...
								<select name="supermenu_tophomelink">
				  					...
				  					<?php if ($supermenu_tophomelink == 'light') { ?>
                  						<option value="light" selected="selected">Да - светлая иконка</option>
                  					<?php } else { ?>
                  						<option value="light">Да - светлая иконка</option>
                  					<?php } ?>
				  					<?php if ($supermenu_tophomelink == 'dark') { ?>
                  						<option value="dark" selected="selected">Да - темная иконка</option>
                  					<?php } else { ?>
                  						<option value="dark">Да - темная иконка</option>
                  					<?php } ?>
								</select>		  
							</div>
							<div class="settings-row">
							...
							<div class="settings-row">
								...
								<select name="supermenu_dropdowneffect">
				  					...
				  					<?php if ($supermenu_dropdowneffect == 'show') { ?>
                  						<option value="show" selected="selected">Только показать</option>
                  					<?php } else { ?>
							...
							<h2 class="h2settings"><?php echo $text_settings_fproduct; ?></h2>
		  					<div class="form-group">
            					<label class="col-sm-2 control-label" for="input-product">Товары</label>
            					<div class="col-sm-10">
              						<input type="text" name="product" value="" placeholder="Введите название товара" id="input-product" class="form-control" />
						...
						<div class="col-sm-7 col-xs-12" >
							...
							<div class="settings-row">
								<b style="font-size: 16px">Использовать собственные настройки дизайна </b> 
							...
							<div class="settings-row">
								Шрифт: <span style="color: #06f; font-weight: normal; font-size: 11px;">( введите название шрифта, если нужно )</span>
								<input type="text" name="supermenu_settings[fontf]" value="<?php echo isset($settings['fontf']) ? $settings['fontf'] : ''; ?>" size="25" /> 
							</div>
							<div class="settings-row">
								Размер шрифта главных пунктов меню: 
							...
							<div class="settings-row">
								Размер шрифта пунктов меню в выпадающем списке: 
							...
							<div class="settings-row">
		 						Градиент фона главного меню:
	     						<input type="text" name="supermenu_settings[bg]" class="sm-colors" value="<?php echo isset($settings['bg']) ? $settings['bg'] : ''; ?>" size="7" /> к
							...
							<div class="settings-row">
		 						...
		 						<select name="supermenu_settings[tmbordero]">
                  					...
                  					<?php } ?>
                  					<option value="all-around">все</option>
							...
							<div class="settings-row">
	     						Цвет текста элеметов главного меню:
							...
							<div class="settings-row">
	     						Цвет тени текста элеметов главного меню:
							...
							<div class="settings-row">
	     						Цвет фона элемента главного меню при наведении:
	    					...
	    					<div class="settings-row">
		 						Цвет текста ссылок первого уровня в выпадающем окне:
	    					...
	    					<div class="settings-row">
		 						Цвет фона ссылок первого уровня в выпадающем окне:
							...
							<div class="settings-row">
		 						Рамка ссылок первого уровня в выпадающем окне:
	    					...
	    					<div class="settings-row">
	     						Выпадающий список - второй уровень, цвет текста ссылок:
	    					...
	    					<div class="settings-row">
	     						Выпадающий список - второй уровень, цвет фона ссылок:
	    					...
	    					<div class="settings-row">
	     						Выпадающее окно - цвет текста ссылок:
	    					...
	    					<div class="settings-row">
	     						Выпадающее окно - рамка элементов мею:
	    					...
	    					<div class="settings-row">
	     						Цвет текста ссылки "Смотерть все":
							...
							<div class="settings-row">
		 						Градиент фона кнопки "Смотерть все":
							...
							<div class="settings-row">
		 						Фон кнопки "Раскрыть меню" (в мобильном виде):
	     						<input type="text" name="supermenu_settings[expbm]" class="sm-colors" value="<?php echo isset($settings['expbm']) ? $settings['expbm'] : ''; ?>" size="7" /> цвет: <input type="text" name="supermenu_settings[expbmc]" class="sm-colors" value="<?php echo isset($settings['expbmc']) ? $settings['expbmc'] : ''; ?>" size="7" /> <br /> или если раскрыто
								 фон: <input type="text" name="supermenu_settings[expbme]" class="sm-colors" value="<?php echo isset($settings['expbme']) ? $settings['expbme'] : ''; ?>" size="7" /> цвет: <input type="text" name="supermenu_settings[expbmec]"class="sm-colors" value="<?php echo isset($settings['expbmec']) ? $settings['expbmec'] : ''; ?>" size="7" />
	    					</div>
						</div>
					</div>
		  		</div>
		 			...
		 			<div class="tab-content">
		 				<?php foreach ($languages as $language) { ?>
          					<div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
				 				<div class="form-group">
                    				<label class="col-sm-2 control-label" for="area1<?php echo $language['language_id']; ?>">Блок 1</label>
                    				<div class="col-sm-10">
				 				...
				 				<div class="form-group">
                 				   <label class="col-sm-2 control-label" for="area2<?php echo $language['language_id']; ?>">Блок 2</label>
                 				   <div class="col-sm-10">
				 				...
				 				<div class="form-group">
                 				   <label class="col-sm-2 control-label" for="area3<?php echo $language['language_id']; ?>">Блок 3</label>
                 				   <div class="col-sm-10">
				 				...
				 				<div class="form-group">
                 				   <label class="col-sm-2 control-label" for="area4<?php echo $language['language_id']; ?>">Блок 4</label>
                 				   <div class="col-sm-10">
				 				...
				 				<div class="form-group">
                 				   <label class="col-sm-2 control-label" for="area5<?php echo $language['language_id']; ?>">Блок 5</label>
                 				   <div class="col-sm-10">
				 				...
				 				<div class="form-group">
                 				   <label class="col-sm-2 control-label" for="area6<?php echo $language['language_id']; ?>">Блок 6</label>
                 				   <div class="col-sm-10">
				 				...
				 				<div class="form-group">
                 				   <label class="col-sm-2 control-label" for="area7<?php echo $language['language_id']; ?>">Блок 7</label>
                 				   <div class="col-sm-10">
				 				...
				 				<div class="form-group">
                 				   <label class="col-sm-2 control-label" for="area8<?php echo $language['language_id']; ?>">Блок 8</label>
                 				   <div class="col-sm-10">
				 				...
				 				<div class="form-group">
                 				   <label class="col-sm-2 control-label" for="area9<?php echo $language['language_id']; ?>">Блок 9</label>
                 				   <div class="col-sm-10">
				 				...
				 				<div class="form-group">
                 				   <label class="col-sm-2 control-label" for="area10<?php echo $language['language_id']; ?>">Блок 10</label>
                 				   <div class="col-sm-10">
...
function additem() {	
	...
	<?php } ?>
	html += '		</div></div></td> ';
	html += '    <td class="text-left"><style type="text/css"> .advm' + item_row + ' .advh { display: none; } </style><div class="advm' + item_row + ' advs"><a class="expand"><?php echo $text_expando; ?></a><div class="advh"><a class="closeadvm"><strong><span style="font-size:20px;"><span style="font-family:lucida sans unicode,lucida grande,sans-serif;">x</span></span></strong></a><table class="smenua"><tr><td><?php echo $text_tlcolor; ?></td><td><input type="text" class="sm-colors" name="supermenu_item[' + item_row + '][tlcolor]" value="" size="7" /></td><td><?php echo $text_tlstyle; ?></td><td><input type="text" name="supermenu_item[' + item_row + '][tlstyle]" value="" size="28" /></td></tr><tr><td><?php echo $text_chtml; ?></td><td><select name="supermenu_item[' + item_row + '][chtml]"><option value="0"><?php echo $text_no; ?></option><option value="1"><?php echo $text_alldrop; ?></option><option value="3"><?php echo $text_overdrop; ?></option><option value="2"><?php echo $text_justadd; ?></option></select><select name="supermenu_item[' + item_row + '][cchtml]"><option value="area1">Блок 1</option><option value="area2">Блок 2</option><option value="area3">Блок 3</option><option value="area4">Блок 4</option><option value="area5">Блок 5</option><option value="area6">Блок 6</option><option value="area7">Блок 7</option><option value="area8">Блок 8</option><option value="area9">Блок 9</option><option value="area10">Блок 10</option></select></td><td><?php echo $text_subcatdisplay; ?></td><td><select name="supermenu_item[' + item_row + '][subcatdisplay]"><option value="all"><?php echo $text_subcatdisplay_all; ?></option><option value="level1"><?php echo $text_subcatdisplay_level1; ?></option><option value="none"><?php echo $text_subcatdisplay_none; ?></option></select></td></tr><tr><td><?php echo $text_dwidth; ?></td><td><input type="text" name="supermenu_item[' + item_row + '][dwidth]" value="" size="3" /></td><td><?php echo $text_iwidth; ?></td><td><input type="text" name="supermenu_item[' + item_row + '][iwidth]" value="" size="3" /></td></tr><tr><td><?php echo $text_fbrands; ?></td><td colspan="3"><input type="text" name="supermenu_item[' + item_row + '][fbrands]" value="" size="48" /></td></tr></table></div></div>';
    html += '</td>';
...
<style type="text/css">
  table.list td {
	...
	h3.addsuperh3 {margin-top: 5px; margin-bottom: 5px; border-bottom: 1px solid #ddd; padding-bottom: 3px; color: #FF7200; cursor: pointer; margin-right: 70px;font-size: 16px;}
