                                                            ...
                                                            <tr id="payment_address_<?php echo $field['id']; ?>_input"
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <?php if($setting['step']['payment_address']['fields'][$field['id']]['type'] == 'text'
                                                                          ...
                                                                          || $setting['step']['payment_address']['fields'][$field['id']]['type'] == 'tel' 
                                                                ...
                                                                <td >
                                                                    <?php if(isset($setting['account'][$option]['payment_address']['fields'][$field['id']]['display'])) { ?>
                                                                        ...
                                                                        <?php if(isset($setting['account'][$option]['payment_address']['fields'][$field['id']]['require'])) { ?>
                                                                            ...
                                                                            <input type="checkbox" value="1" data-size="mini" data-label-text="<?php echo $text_require; ?>" name="<?php echo $id; ?>_setting[account][<?php echo $option; ?>][payment_address][fields][<?php echo $field['id']; ?>][require]" <?php if($setting['account'][$option]['payment_address']['fields'][$field['id']]['require'] == 1){ ?>checked="checked"<?php } ?> id="<?php echo $option; ?>_payment_address_fields_<?php echo $field['id']; ?>_require"/>
                                                                        <?php } //require?>
                                                                    <?php } //display ?>
                                                                </td>
                                                                <?php } ?>
                                                        ...
                                                        <?php foreach($setting['step']['shipping_address']['fields'] as $field){ if(isset($field['title'])){ ?>
                                                            <tr id="shipping_address_<?php echo $field['id']; ?>_input" class="sort-item <?php echo ($field['type'] == 'system')? 'hide' : ''; ?>" sort-data="<?php echo (isset($setting['step']['shipping_address']['fields'][$field['id']]['sort_order']) ? $setting['step']['shipping_address']['fields'][$field['id']]['sort_order'] : ''); ?>">
                                                                ...
                                                                <?php if($setting['step']['shipping_address']['fields'][$field['id']]['type'] == 'text'
                                                                      ...
                                                                      || $setting['step']['shipping_address']['fields'][$field['id']]['type'] == 'tel' 
...
<script type="text/javascript"><!--
    ...
    $(function () {
        ...
        $('body').on('click', '#compress_update', function (e) {
            $.ajax({
                ...
                url: 'index.php?route=extension/module/d_quickcheckout/updateCompress&token=<?php echo $token; ?>',
                type: 'post',
                dataType: 'json',
    ...
    $('body').on('change', '#payment_address_country_id_input select', function () {
        $.ajax({
            url: 'index.php?route=extension/module/d_quickcheckout/getZone&token=<?php echo $token; ?>&country_id=' + this.value,
            dataType: 'json',
            success: function(json) {
