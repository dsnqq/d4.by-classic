    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <form action="<?php echo $action; ?>" id="tv-module-form" method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <p style="color: red">Make sure to read the readme file to complete the installation!</p>
            <p>If you have any feature request contact us. One email address for all your Opencart inquiries: support@prowebtec.com</p>
...
<div><small>Like and Claim your discount coupon code</small></div>
