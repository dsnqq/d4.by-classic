...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      ...
      <?php /*<a href="<?php echo $repair; ?>" data-toggle="tooltip" title="<?php echo $button_rebuild; ?>" class="btn btn-default"><i class="fa fa-refresh"></i></a> */ ?>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($category['category_id'], $selected)) { ?>
                    ...
                    <td class="left"><?php echo $category['indent']; ?><a href="<?php echo $category['href']; ?>"><?php echo $category['name']; ?></a>&nbsp;&nbsp;<i class="fa fa-sort-desc"></i> - <?php echo $category['category_id']; ?></td>
                  <?php } else { ?>
                    <td class="left"><?php echo $category['indent']; ?><?php echo $category['name']; ?> - <?php echo $category['category_id']; ?></td>
                  <?php } ?>
