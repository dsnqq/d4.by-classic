	...
	<div class="row">
		<div class="col-sm-12">
			...
			<div id="product-category" class="well well-sm" style="height: 150px; overflow: auto;">
				...
				<div id="product-category<?php echo $product_category['category_id']; ?>"><i class="fa fa-minus-circle" onclick="$(this).parent().remove();"></i> <?php echo $product_category['name']; ?>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="well well-sm" style="height: 150px; overflow: auto;">
				...
				<div class="checkbox">
					<label>
						<input type="checkbox" name="product_store[]" value="<?php echo $store['store_id']; ?>"<?php echo (in_array($store['store_id'], $product_store)) ? ' checked="checked"' : ''; ?>/>
						<?php echo $store['name']; ?>
					</label>
				</div>
				<?php } ?>
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<div id="product-filter" class="well well-sm" style="height: 150px; overflow: auto;">
				...
				<div id="product-filter<?php echo $product_filter['filter_id']; ?>"><i class="fa fa-minus-circle" onclick="$(this).parent().remove();"></i> <?php echo $product_filter['name']; ?>
...
//--></script>
	...
	<div class="table-responsive">
		<table id="images" class="table table-striped table-bordered table-hover">
			...
			<td class="text-left"><button type="button" onclick="$(this).tooltip('destroy');$('#image-row<?php echo $image_row; ?>').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger">Удалить изображение</button></td>
				</tr>
				<?php $image_row++; ?>
				<?php } ?>
			</tbody>
			<tfoot>
				<tr>
					<td colspan="2"></td>
			<td class="text-left"><button type="button" onclick="addImage();" data-toggle="tooltip" title="<?php echo $button_image_add; ?>" class="btn btn-primary">Добавить изображение</button></td>
				</tr>
			</tfoot>
		</table>
	</div>
...
function addImage() {
	...
	html += '  <td class="text-left"><button type="button" onclick="$(this).tooltip(\'destroy\');$(\'#image-row' + image_row  + '\').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger">Удалить изображение</button></td>';
	html += '</tr>';
...
<script type="text/javascript"><!--
<?php foreach ($languages as $language) { ?>
$('#input-description<?php echo $language['language_id']; ?>').on('summernote.change', function(we, contents, $editable) {
