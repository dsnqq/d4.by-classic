...
<div id="content">
                ...
                <table id="links" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr id="links-row<?php echo $links_row; ?>">
					  ...
					  <?php foreach($languages as $language) { ?>
					  <img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" style="display:inline-block;"/> <input type="text" name="category_links[<?php echo $links_row; ?>][name][<?php echo $language['language_id']; ?>]" value="<?php if (isset($category_link['name'][$language['language_id']])) echo $category_link['name'][$language['language_id']]; ?>" class="form-control" style="display:inline-block;width:80%;" /><br>
					  <?php } ?>
					  </td>
                      <td class="text-center">
					  <?php foreach($languages as $language) { ?>
					  <img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" style="display:inline-block;"/> <input type="text" name="category_links[<?php echo $links_row; ?>][link][<?php echo $language['language_id']; ?>]" value="<?php if (isset($category_link['link'][$language['language_id']])) echo $category_link['link'][$language['language_id']]; ?>" class="form-control" style="display:inline-block;width:80%;" /><br>
					  <?php } ?> 
					  </td>
                      <td class="text-center"><input type="text" name="category_links[<?php echo $links_row; ?>][sort_order]" value="<?php echo $category_link['sort_order']; ?>" class="form-control" /></td>
                      <td class="text-center">
					  <label class="radio-inline">
					 <?php if ($category_link['target']) { ?>
                    <input type="radio" name="category_links[<?php echo $links_row; ?>][target]" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input type="radio" name="category_links[<?php echo $links_row; ?>][target]" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$category_link['target']) { ?>
                    <input type="radio" name="category_links[<?php echo $links_row; ?>][target]" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="category_links[<?php echo $links_row; ?>][target]" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
					  </td>
  ...
  function addLink() {
	...
	<?php foreach($languages as $language) { ?>
	html += ' <img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" style="display:inline-block;"/> <input type="text" name="category_links[' + links_row + '][name][<?php echo $language['language_id']; ?>]" value="" class="form-control" style="display:inline-block;width:80%;" /><br>';
	<?php } ?>
	html += '</td>';
    html += '  <td class="text-center">';
	<?php foreach($languages as $language) { ?>
	html += ' <img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" style="display:inline-block;"/> <input type="text" name="category_links[' + links_row + '][link][<?php echo $language['language_id']; ?>]" value="" class="form-control" style="display:inline-block;width:80%;" /><br>';
	<?php } ?>
	html += '</td>';
	html += '  <td class="text-center" style="width:10%"><input type="text" name="category_links[' + links_row + '][sort_order]" value=""  class="form-control" /></td>';
	html += '  <td class="text-center" style="width:10%"><label class="radio-inline"><input type="radio" name="category_links[' + links_row + '][target]" value="1" /><?php echo $text_yes; ?></label><label class="radio-inline"><input type="radio" name="category_links[' + links_row + '][target]" value="0" checked="checked" /><?php echo $text_no; ?></label></td>';
