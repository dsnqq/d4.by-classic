  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
		<?php if (isset($product_page)) { ?><a class="btn btn-info hide" href="<?php echo $product_page; ?>" target="_blank" data-toggle="tooltip" title="<?php echo $button_view; ?>"><i class="fa fa-eye"></i></a><?php } ?>
        <button type="submit" form="form-product" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="hide btn btn-primary"><i class="fa fa-save"></i></button>
        <a href="<?php echo $cancel; ?>" data-toggle="tooltip" title="Назад" class="btn btn-default"><i class="fa fa-reply"></i> Вернуться к архиву</a></div>
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="form-group required">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-2" style="margin-left: -25px;">
                  <input type="text" name="version" value="<?php echo $version; ?>" placeholder="Модификация" id="input-version" class="form-control" />
                </div>
              </div>
            ...
            <div class="form-group ">
                ...
                <div class="col-sm-2 padding-l-r-2">
                  <select id="main__isbn" name="isbn" class="form-control selectpicker" data-live-search="true">
                        <option value="" <?php echo ($isbn == "") ? "selected='selected'" : "" ; ?>>Выберите</option>
                        <option value="дизель" <?php echo ($isbn == "дизель") ? "selected='selected'" : "" ; ?>>дизель</option>
                        <option value="бензин" <?php echo ($isbn == "бензин") ? "selected='selected'" : "" ; ?>>бензин</option>
                        <option value="гибрид" <?php echo ($isbn == "гибрид") ? "selected='selected'" : "" ; ?>>гибрид</option>
                        <option value="гибрид" <?php echo ($isbn == "электро") ? "selected='selected'" : "" ; ?>>электро</option>
                  </select>
                </div>
                ...
                <div class="col-sm-2 padding-l-r-2">
                  <select id="main__mpn" name="mpn" class="form-control selectpicker" data-live-search="true">
                        <option value="" <?php echo ($mpn == "") ? "selected='selected'" : "" ; ?>>Выберите</option>
                        <?php foreach($mpn_array as $mpn_array_item){ ?>
                          <option data-chained="<?php echo $mpn_array_item[1]; ?>" value="<?php echo $mpn_array_item[0]; ?>" <?php echo ($mpn_array_item[0] == $mpn) ? "selected='selected'" : "" ; ?>><?php echo $mpn_array_item[0]; ?></option>
                        <?php } ?>
                  </select>
                </div> 
            </div>
            ...
            <div class="form-group">
                ...
                <?php /* Коробка */ ?>
                <div class="col-sm-2 padding-l-r-2">
                  <select id="" name="upc" class="form-control selectpicker" data-live-search="true">
                        <option value="" <?php echo ($upc == "") ? "selected='selected'" : "" ; ?>>Выберите</option>
                        <?php foreach($upc_array as $upc_array_item){ ?>
                          <option value="<?php echo $upc_array_item; ?>" <?php echo ($upc_array_item == $upc) ? "selected='selected'" : "" ; ?>><?php echo $upc_array_item; ?></option>
                        <?php } ?>
                  </select>
                </div>
            </div>
            ...
            <?php /* Dop polija dla diskov */ ?>
              <div class="disk_hide">
                <div class="form-group ">
                  <?php /* Диаметр R, дюймы */ ?>
                  <label class="col-sm-2 control-label" for="input-location">Диаметр R, дюймы: </span></label>
                  <div class="col-sm-2 padding-r-2">
                    <select id="main__location" name="location" class="form-control selectpicker" data-live-search="true">
                          <option value="" <?php echo ($location == "") ? "selected='selected'" : "" ; ?>>Выберите</option>
                          <?php foreach($location_array as $location_array_item){ ?>
                            <option value="<?php echo $location_array_item; ?>" <?php echo ($location_array_item == $location) ? "selected='selected'" : "" ; ?>><?php echo $location_array_item; ?></option>
                          <?php } ?>
                    </select>
                  </div> 
                </div> 
                ...
                <div class="form-group ">
                  <?php /* Ширина J, дюймы */ ?>
                  <label class="col-sm-2 control-label" for="input-width">Ширина J, дюймы: </span></label>
                  <div class="col-sm-2 padding-r-2">
                    <select id="main__width" name="width" class="form-control selectpicker" data-live-search="true">
                          <option value="" <?php echo ($width == "") ? "selected='selected'" : "" ; ?>>Выберите</option>
                          <?php foreach($width_array as $width_array_item){ ?>
                            <option value="<?php echo $width_array_item; ?>" <?php echo ($width_array_item == $width) ? "selected='selected'" : "" ; ?>><?php echo $width_array_item; ?></option>
                          <?php } ?>
                    </select>
                  </div> 
                </div> 
                ...
                <div class="form-group ">
                  <?php /* Кол-во отверстий */ ?>
                  <label class="col-sm-2 control-label" for="input-height">Кол-во отверстий: </span></label>
                  <div class="col-sm-2 padding-r-2">
                    <select id="main__height" name="height" class="form-control selectpicker" data-live-search="true">
                          <option value="" <?php echo ($height == "") ? "selected='selected'" : "" ; ?>>Выберите</option>
                          <?php foreach($height_array as $height_array_item){ ?>
                            <option value="<?php echo $height_array_item; ?>" <?php echo ($height_array_item == $height) ? "selected='selected'" : "" ; ?>><?php echo $height_array_item; ?></option>
                          <?php } ?>
                    </select>
                  </div> 
                </div> 
                ...
                <div class="form-group ">
                  <?php /* Расстояние между отверстиями PCD, мм */ ?>
                  <label class="col-sm-2 control-label" for="input-weight">Расстояние между отверстиями PCD, мм: </span></label>
                  <div class="col-sm-2 padding-r-2">
                    <select id="main__weight" name="weight" class="form-control selectpicker" data-live-search="true">
                          <option value="" <?php echo ($weight == "") ? "selected='selected'" : "" ; ?>>Выберите</option>
                          <?php foreach($weight_array as $weight_array_item){ ?>
                            <option value="<?php echo $weight_array_item; ?>" <?php echo ($weight_array_item == $weight) ? "selected='selected'" : "" ; ?>><?php echo $weight_array_item; ?></option>
                          <?php } ?>
                    </select>
                  </div> 
                </div> 
                ...
                <div class="form-group ">
                  <?php /* Вылет */ ?>
                  <label class="col-sm-2 control-label" for="input-etvylet">Вылет ET, мм: </span></label>
                  <div class="col-sm-1 padding-r-2">
                    <input type="text" name="etvylet" value="<?php echo $etvylet; ?>" placeholder="" id="input-etvylet" class="form-control" />
                  </div>
                </div> 

                <div class="form-group ">
                  <?php /* Диаметр центрального отверстия DIA, мм */ ?>
                  <label class="col-sm-2 control-label" for="input-diadiametr">Диаметр центрального отверстия DIA, мм: </span></label>
                  <div class="col-sm-2 padding-r-2">
                    <select id="main__diadiametr" name="diadiametr" class="form-control selectpicker" data-live-search="true">
                          <option value="" <?php echo ($diadiametr == "") ? "selected='selected'" : "" ; ?>>Выберите</option>
                          <?php foreach($diadiametr_array as $diadiametr_array_item){ ?>
                            <option value="<?php echo $diadiametr_array_item; ?>" <?php echo ($diadiametr_array_item == $diadiametr) ? "selected='selected'" : "" ; ?>><?php echo $diadiametr_array_item; ?></option>
                          <?php } ?>
                    </select>
                  </div> 
                </div> 
              </div>
              <?php /* End dop polija dla diskov */ ?>
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <script>
                   setInterval(function(){
                      // заполняем поле name
                      name = $("#input-manufacturer option:selected").text();
            ...
            <div class="tab-pane active" id="tab-data">
              ...
              <div class="form-group ">
                ...
                <div class="col-sm-3">
		  <?php if($product_specials[0]['price'] && $product_specials[0]['price'] != 0){ 
                  ...
                  <table id="special" class="">
                    ...
                    <tbody>
                      <tr id="special-row0">
                        ...
                        <td class="text-right">
                          <input type="text" name="product_special[0][price]" value="<?php echo (!$product_specials[0]['price']) ? "0": $product_specials[0]['price']; ?>" placeholder=""  class="itogo_price" style="border:none;outline:none;">
                        </td>
...
<?php /*
        ...
        <?php
            ...
            /* Генерация QR-кода во временный файл */
              ...
              QRcode::png('https://d4.by/gd/?product_id='.$_GET['product_id'], $_SERVER["DOCUMENT_ROOT"].'/gd/qr/'.$model.'_tmp.png', 'Q', 6, 1);
           
            
            /* Конвертация PNG8 в PNG24 */
            $im = imagecreatefrompng($_SERVER["DOCUMENT_ROOT"].'/gd/qr/'.$model.'_tmp.png');
            ...
            imagepng($dst,$_SERVER["DOCUMENT_ROOT"].'/gd/qr/'.$model.'_main.png',3);
            
            unlink($_SERVER["DOCUMENT_ROOT"].'/gd/qr/'.$model.'_tmp.png');

            //$img_sm_qr = '<img src="https://d4.by/gd/qr/'.$model.'_main.png" style="width:200px;">';
            $img_sm_qr1 = '<img src="https://d4.by/gd/qr/'.$model.'_main.png" style="width:110px;">';
            echo '<br><br>';
			...
			if($(this).val() === "" || $(this).val() === "0" || $(this).val() === 0){
			  ...
			  $('#special_class').html("");
                      ...
                      $('#input-price').on('input', function(){
                        if($('#input-price').val() !== ""){
                          var itogo = parseInt($('#input-price').val()) - (parseInt($('#input-price').val())/100)*parseInt($('.procent_price').val());
                          if(parseInt($('.procent_price').val()) >= 5 && ($('#special_class').html().trim() === '' || $('#special_class').html().trim() === ' ' || $('#special_class').html().trim() === '  ')){ 
                            $('#special_class').append('<div class="table-responsive"> Цена для сайта: <table id="special" class=""> <thead class="hide"> <tr> <td class="text-left">Группа покупателей:</td> <td class="text-right">Приоритет:</td> <td class="text-right">Цена в долларах:</td> <td class="text-left">Дата начала:</td> <td class="text-left">Дата окончания:</td> <td></td> </tr> </thead> <tbody> <tr id="special-row0"> <td class="text-left hide"> <select name="product_special[0][customer_group_id]" class="form-control"> <option value="1">Default</option> </select> </td> <td class="text-right hide"> <input type="text" name="product_special[0][priority]" value="<?php $product_specials[0]['priority']; ?>" placeholder="Приоритет:" class="form-control"> </td> <td class="text-right"> <input type="text" name="product_special[0][price]" value="<?php echo (!$product_specials[0]['price']) ? " 0 ": $product_specials[0]['price']; ?>" placeholder="" class="itogo_price" style="border:none;outline:none;"> </td> <td class="text-left hide" style="width: 20%;"> <div class="input-group date"> <input type="text" name="product_special[0][date_start]" value="<?php $product_specials[0]['date_start']; ?>" placeholder="Дата начала:" data-date-format="YYYY-MM-DD" class="form-control"><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div> </td> <td class="text-left hide" style="width: 20%;"> <div class="input-group date"> <input type="text" name="product_special[0][date_end]" value="<?php $product_specials[0]['date_end']; ?>" placeholder="Дата окончания:" data-date-format="YYYY-MM-DD" class="form-control"><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div> </td> <td class="text-left hide"> <button type="button" data-toggle="tooltip" title="Удалить" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button> </td> </tr> </tbody> </table></div>');
                            }
                          ...
                          if($('.procent_price').val() === "" || $('.procent_price').val() === "0" || $('.procent_price').val() === 0){
                            $('.itogo_price').val(parseInt($('#input-price').val()));
                            $('#special_class').html("");
                          }
                      });
...
$(document).ready(function() { // 
  ...
  $("#main__mpn").chained("#main__isbn");
  $("#main__isbn").change(function(){
    $("#main__mpn").selectpicker('refresh');
  });
  <?php if(($isbn != "")){ // если не выбран тип, а только топливо ?>
    $("#main__mpn").selectpicker('refresh');
  <?php } ?>
});
</script>
...
$(document).ready(function() { 
    ...
    window.onload = function(){
      if($('#input-manufacturer').val() == "262" || $('#input-manufacturer').val() == "257"){
        $('.disk_hide').fadeIn();
      }else{
        $('.disk_hide').fadeOut();
      }
