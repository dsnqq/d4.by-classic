...
<?php /*
        ...
        <?php
            ...
            /* Генерация QR-кода во временный файл */
              ...
              QRcode::png('https://d4.by/gd/?product_id='.$_GET['product_id'], '/home/dby/sites/d4.by/gd/qr/'.$model.'_tmp.png', 'Q', 6, 1);
           
            
            /* Конвертация PNG8 в PNG24 */
            $im = imagecreatefrompng('/home/dby/sites/d4.by/gd/qr/'.$model.'_tmp.png');
            ...
            imagepng($dst,'/home/dby/sites/d4.by/gd/qr/'.$model.'_main.png',3);
            
            unlink('/home/dby/sites/d4.by/gd/qr/'.$model.'_tmp.png');
