...
$query = "SELECT * FROM `oc_product` WHERE status != '0' AND manufacturer_id IN (243,457,458,2055,2054,2053,1181,2276,2051,459,895)";
...
// Создаем массив
//kama_create_xls_file($create_data, $DIR . 'export/csv_engine_transmission_steering_rack.xls');
kama_create_csv_file($create_data, $DIR . 'export/csv_engine_transmission_steering_rack.csv');
