...
while($result_item = mysqli_fetch_array($result)){
    ...
    // Получаем телефон и складкую информацию
    $tel = '';
    $sklad = '';
    $city_s = '';
...
echo 'Выполнено обновление файла для заливки З/Ч на bamper.by. Дата и Время: ' . date("d.m.Y H:i:s");

// Создаем массив
kama_create_csv_file($create_data, $DIR . 'bamper/csv_for_bamper.csv');
