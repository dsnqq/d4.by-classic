	...
	public function __construct($adaptor = 'native') {
		...
		if ($this->adaptor && !session_id()) {
            ...
            if(defined('APPLICATION_CONFIG') && APPLICATION_CONFIG == 'admin'){    //only for admin to avoid API errors.
                ...
                include_once(\VQMod::modCheck(DIR_SYSTEM . 'helper/lolo.php'));
